...
def roles_permisos():
    ...
    for puesto in puestos:
        ...
        if nombre == "gerente general":

            rol_nombre = "gerente_area"

        elif nombre == "gerente de operaciones":

            rol_nombre = "gerente_operaciones"

        elif nombre == "gerente de recursos humanos":

            rol_nombre = "rh"

        elif nombre == "supervisor de producción":

            rol_nombre = "supervisor"

        elif nombre == "supervisor de mp":

            rol_nombre = "supervisor"

        puesto_rol[puesto.id] = rol_nombre

    # --------------------------------------------------------
    # POST
    #
    # Todavia no se persiste Puesto -> Rol.
    # Se deja protegido para que solo administrador
    # pueda enviar modificaciones.
    # --------------------------------------------------------
