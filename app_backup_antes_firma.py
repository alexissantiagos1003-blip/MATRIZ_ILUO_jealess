...
def guardar_evaluacion():
    ...
    if not colaborador_id:
        return "Colaborador no especificado.", 400
    ...
    if fecha_evaluacion:
        ...
        try:
            ...
            return "La fecha de evaluación no es válida.", 400
    ...
    if rol_evaluador and rol_evaluador not in roles_validos:

        return "El rol del evaluador no es válido.", 400
    ...
    for asignacion in habilidades_asignadas:
        ...
        # Si la habilidad no fue evaluada
        # no modificamos su evaluación anterior.
        ...
        if nivel not in niveles_validos:
            ...
            return (
                f"Nivel ILUO inválido para la habilidad "
                f"{habilidad_id}.",
                400
            )

        # =========================
        # BUSCAR EVALUACIÓN ACTUAL
        # =========================
