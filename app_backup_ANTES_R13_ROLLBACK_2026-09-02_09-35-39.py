...
def roles_permisos():
    ...
    # POST
    #
    # En esta etapa NO se persiste Puesto -> Rol.
    # Solo se protege el acceso de escritura.
    # --------------------------------------------------------
    ...
    for puesto in puestos:
        ...
        elif nombre_puesto == "gerente de operaciones":

            rol_nombre = "gerente_operaciones"

        elif nombre_puesto == "gerente de recursos humanos":

            rol_nombre = "rh"

        elif nombre_puesto in [
