...
def dominio_brechas():
    ...
    # -----------------------------------------------------
    # FILTRAR DEPARTAMENTOS SEGÚN ÁREA
    # -----------------------------------------------------
    ...
    # -----------------------------------------------------
    # FILTRAR PUESTOS SEGÚN DEPARTAMENTO
    # -----------------------------------------------------
    ...
    if colaborador_actual:
        ...
        for detalle in (
            ...
            try:
                ...
                # -------------------------------------------------
                # Compatibilidad si el modelo Curso no tiene
                # habilidad_id directo
                # -------------------------------------------------
