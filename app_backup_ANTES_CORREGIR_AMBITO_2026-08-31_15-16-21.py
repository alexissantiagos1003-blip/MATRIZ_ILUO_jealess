...
def puede_actuar_sobre_puesto(
    ...
    # Todo el alcance de OPERACIONES
    # --------------------------------------------------------
    ...
    if usuario.rol == "gerente_operaciones":
        ...
        return (
            puesto.area.nombre.strip().lower()
            ==
            "operaciones"
        )
    ...
    # --------------------------------------------------------
    # GERENTE DE AREA
    # Por ahora utiliza el area del colaborador asociado
    # --------------------------------------------------------
    ...
    if usuario.rol == "gerente_area":
        ...
        gerente_departamento = (
            usuario.colaborador.departamento
        )


        if not gerente_departamento:

            return False


        if not gerente_departamento.area:
    ...
    # --------------------------------------------------------
    # SUPERVISOR
    # Usa relaciones directas y matriciales de PuestoRelacion
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # RH
    # Consulta/gestiona información autorizada a nivel empresa
    # El permiso de EDITAR se controla por separado.
    # --------------------------------------------------------
