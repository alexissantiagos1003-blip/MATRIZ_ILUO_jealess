...
def roles_permisos():
    ...
    for puesto in puestos:
        ...
        if (
            puesto.nombre
            and puesto.nombre.strip().lower()
            == "gerente general"
        ):

            categoria = "gerente general"

        elif rol_interno == "gerente_area":

            categoria = "gerente de área"

        elif rol_interno == "supervisor":
