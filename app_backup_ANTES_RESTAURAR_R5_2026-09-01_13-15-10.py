...
def historial_colaborador(id):
    ...
    #
    # No ignora diferencias internas reales.
    # ========================================================
...
def editar_colaborador(id):
    ...
    if request.method == "POST":
        ...
        if not motivo:
            return (
                "El motivo de la modificacion es obligatorio.",
                400
            )
        ...
        try:
            ...
            departamento = Departamento.query.get(
                int(departamento_id)
            )
        ...
        if departamento.area_id != area.id:
            ...
            return (
                "El departamento no pertenece al area seleccionada.",
                400
            )
        ...
        # ====================================================
        # VALORES ANTERIORES NORMALIZADOS
        # ====================================================
        ...
        if not cambios:
            ...
            return (
                "No se detectaron cambios reales en el colaborador.",
                400
            )
        ...
        if not usuario:
            ...
            return (
                "La sesion del usuario no es valida.",
                401
            )


        # ====================================================
        # APLICAR CAMBIOS NORMALIZADOS
        # ====================================================
