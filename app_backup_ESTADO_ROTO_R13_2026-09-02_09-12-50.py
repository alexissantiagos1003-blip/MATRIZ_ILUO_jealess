...
# ============================================================
# ============================================================
# ADMINISTRACION DE PUESTOS / ROLES / PERMISOS
# ============================================================
...
def roles_permisos():
    ...
    if request.method == "POST":
        ...
        for puesto in puestos:
            ...
            # Por ahora almacenamos la configuracion
            # visual en memoria de la pantalla.
            # La persistencia puesto -> rol se implementara
            # en el siguiente paso despues de validar la UI.
